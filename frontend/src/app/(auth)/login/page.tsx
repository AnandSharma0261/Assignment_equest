          ...
          <AuthCard>
            ...
            <div className="flex flex-col gap-6 border-t border-[color:var(--color-border-faint)] pt-8">
              <div className="relative flex items-center justify-center">
                <span className="text-xs font-bold uppercase tracking-[1.2px] text-[color:var(--color-ink-muted)]">
                  Or continue with
                </span>
              </div>
...
function OAuthButton({ provider }: { provider: 'google' | 'github' }) {
  ...
  return (
    <button
      ...
      className="flex h-12 w-full cursor-not-allowed items-center justify-center gap-3 rounded-[8px] bg-[color:var(--color-button-soft)] text-base font-medium text-ink opacity-90"
    >
...
function GoogleGlyph() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.07 5.07 0 0 1-2.2 3.32v2.77h3.56c2.08-1.92 3.28-4.75 3.28-8.1Z" />
      <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.65l-3.56-2.77c-.99.67-2.26 1.07-3.72 1.07-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0 0 12 23Z" />
      <path fill="#FBBC05" d="M5.84 14.12a6.6 6.6 0 0 1 0-4.23V7.05H2.18a11 11 0 0 0 0 9.9l3.66-2.83Z" />
      <path fill="#EA4335" d="M12 4.75c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 1.4 14.97.5 12 .5A11 11 0 0 0 2.18 7.05l3.66 2.84C6.71 7.29 9.14 4.75 12 4.75Z" />
    </svg>
  );
}
